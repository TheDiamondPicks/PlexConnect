...
g_settings = [
 ...
 \
    ...
    ('prevent_atv_update', ('False', '((True)|(False))')),
    ('intercept_atv_icon', ('False', '((True)|(False))')), \
 \
 ...
 \
    ('hosttointercept', ('www.crunchyroll.com', '[a-zA-Z0-9_.-]+')),
    ('icon', ('crunchyroll', '[a-zA-Z0-9_.-]+')),
    ('certfile', ('./assets/certificates/trailers.pem', '.+.pem')), \
 \
    ('port_webserver', ('8082', '[0-9]{1,5}')),
    ('enable_webserver_ssl', ('False', '((True)|(False))')),
    ('port_ssl', ('8445', '[0-9]{1,5}')), \
 \
